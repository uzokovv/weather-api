...
const TodayWeather = () => {
    ...
    async function getWeather(countries: CountryType | null) {
                ...
                <div className='' key={1}>
                    ...
                    <div className='flex mt-9'>
                        <div className='flex items-center'>
                            <h1 className='text-white text-5xl md:text-8xl'>{data.current.temp_c}°</h1>
                            <img className='md:w-30 md:h-30 h-25 w-25' src={data.current.condition.icon} alt="weather icon" />
                        </div>
                        <div className='flex justify-center flex-col ml-5 '>
                            <h1 className='text-white text-1xl md:text-2xl'>Aniqlik bilan {data.current.condition.text}</h1>
                            <h1 className='text-white text-1xl md:text-2xl'>His qilinishi: {data.current.feelslike_c}°</h1>
                        </div>
                    </div>
                    <div className='flex justify-between mt-15 w-[100%] md:w-[70%] mx-auto'>
                        <div className='flex gap-3 items-center'>
                            <AirIcon className='text-2xl md:text-3xl text-white' />
